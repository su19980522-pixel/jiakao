...
export const SAMPLE_QUESTIONS = [
  ...
  {
    id: 50006, type: 'single', subject: 1, chapter: 'law',
  ...
  {
    id: 50007, type: 'judge', subject: 1, chapter: 'law',
    question: '在道路上临时停车时，驾驶人不得离开车辆，上下人员或装卸物品后应立即驶离。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '临时停车驾驶人不能离车，妨碍通行时应立即驶离。'
  },
  {
    id: 50008, type: 'single', subject: 1, chapter: 'law',
  ...
  {
    id: 50009, type: 'single', subject: 1, chapter: 'law',
  ...
  {
    id: 50010, type: 'judge', subject: 1, chapter: 'law',
    question: '交通肇事逃逸构成犯罪的，吊销机动车驾驶证，且终生不得重新取得机动车驾驶证。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '造成交通事故后逃逸构成犯罪的，吊销驾驶证且终生禁驾。'
  },
  {
    id: 50011, type: 'single', subject: 1, chapter: 'law',
  ...
  {
    id: 50012, type: 'single', subject: 1, chapter: 'law',
  ...
  // ==================== 科目一 · 交通信号 ====================
  {
    id: 50013, type: 'judge', subject: 1, chapter: 'signal',
    question: '交通信号包括交通信号灯、交通标志、交通标线和交通警察的指挥。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '交通信号由信号灯、标志、标线和交警指挥四部分组成。'
  },
  {
    id: 50014, type: 'single', subject: 1, chapter: 'signal',
  ...
  // ==================== 科目一 · 安全行车、文明驾驶基础知识 ====================
  {
    id: 50025, type: 'single', subject: 1, chapter: 'safe',
  ...
  {
    id: 50030, type: 'single', subject: 1, chapter: 'safe',
  ...
  {
    id: 50035, type: 'judge', subject: 1, chapter: 'safe',
    question: '安全带的作用是在发生碰撞或紧急制动时，将驾乘人员固定在座位上，减轻伤害。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '安全带是最基本的安全防护装置，上车必须系好。'
  },
  {
    id: 50036, type: 'single', subject: 1, chapter: 'safe',
  ...
  {
    id: 50043, type: 'judge', subject: 1, chapter: 'operation',
    question: '轮胎气压不足时继续行驶，容易导致爆胎。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '气压不足会使胎壁过度屈挠发热，高速行驶易爆胎。'
  },
  {
    id: 50044, type: 'single', subject: 1, chapter: 'operation',
  ...
  // ==================== 科目四 · 安全行车常识 ====================
  {
    id: 50045, type: 'single', subject: 4, chapter: 's1',
  ...
  {
    id: 50046, type: 'judge', subject: 4, chapter: 's1',
    question: '驾驶机动车在隧道内行驶时，应当开启近光灯。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '进入隧道前应开启近光灯，保证照明和自身可见性。'
  },
  {
    id: 50047, type: 'multi', subject: 4, chapter: 's1',
  ...
  {
    id: 50048, type: 'single', subject: 4, chapter: 's1',
  ...
  {
    id: 50051, type: 'single', subject: 4, chapter: 's1',
  ...
  {
    id: 50052, type: 'multi', subject: 4, chapter: 's1',
  ...
  // ==================== 科目四 · 文明行车常识 ====================
  {
    id: 50053, type: 'single', subject: 4, chapter: 's2',
  ...
  {
    id: 50054, type: 'judge', subject: 4, chapter: 's2',
    question: '驾驶机动车行经学校门口或人行横道时，应减速慢行，遇行人应当停车让行。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '学校周边和人行横道处行人多，应减速慢行、礼让行人。'
  },
  {
    id: 50055, type: 'single', subject: 4, chapter: 's2',
  ...
  {
    id: 50056, type: 'judge', subject: 4, chapter: 's2',
    question: '夜间会车时，对方车辆不关闭远光灯，自己也应开启远光灯回敬。',
    options: ['正确', '错误'], answer: 'B',
    explanation: '对方不变光时应减速靠右停车避让，切忌开远光灯对射，避免事故。'
  },
  {
    id: 50057, type: 'multi', subject: 4, chapter: 's2',
  ...
  {
    id: 50058, type: 'single', subject: 4, chapter: 's2',
  ...
  {
    id: 50062, type: 'single', subject: 4, chapter: 's3',
  ...
  {
    id: 50063, type: 'judge', subject: 4, chapter: 's3',
    question: '雨天行车，路面湿滑，制动距离会变长。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '雨水使轮胎与路面附着力下降，制动距离变长，应加大跟车距离。'
  },
  {
    id: 50064, type: 'multi', subject: 4, chapter: 's3',
  ...
  // ==================== 科目四 · 紧急情况下避险常识 ====================
  {
    id: 50065, type: 'single', subject: 4, chapter: 's4',
  ...
  {
    id: 50068, type: 'single', subject: 4, chapter: 's4',
  ...
  {
    id: 50069, type: 'judge', subject: 4, chapter: 's4',
  ...
  {
    id: 50070, type: 'single', subject: 4, chapter: 's5',
  ...
  {
    id: 50071, type: 'judge', subject: 4, chapter: 's5',
    question: '抢救昏迷的伤员时，应保持其呼吸道畅通，解开衣领、领带等。',
    options: ['正确', '错误'], answer: 'A',
    explanation: '昏迷伤员应保持呼吸道畅通，防止窒息，尽快送医。'
  },
  {
    id: 50072, type: 'multi', subject: 4, chapter: 's5',
